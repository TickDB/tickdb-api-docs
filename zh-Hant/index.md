---
title: TickDB 文檔
description: 統一即時行情數據 API，支援外匯、指數、美股、港股、A 股、中國期貨與加密貨幣。
---
...
透過 **一次接入（one connection）**，即可無縫存取外匯、貴金屬、指數、美股、港股、A 股、中國期貨與加密貨幣等市場的行情資料。
...
### llms.txt — 為 AI 提供文檔上下文

如需讓 AI 助手了解 TickDB 文檔，可向其提供以下地址：
