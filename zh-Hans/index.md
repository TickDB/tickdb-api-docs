...
- **AI 友好**  
  提供标准化 [SKILL 文件](https://github.com/TickDB/tickdb-unified-realtime-marketdata-api/blob/main/SKILL/SKILL.md)，让 AI 助手自动理解并调用全部接口

---

## AI 集成

TickDB 提供标准化的 [SKILL 文件](https://github.com/TickDB/tickdb-unified-realtime-marketdata-api/blob/main/SKILL/SKILL.md)，可直接用于 AI 助手集成。

使用示例：在 AI 助手中输入以下指令即可开始使用：
