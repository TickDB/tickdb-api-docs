---
title: TickDB 文档
description: 统一实时行情数据 API，支持外汇、指数、美股、港股、A 股、中国期货和加密货币。
---
...
通过 **一次接入（one connection）**，即可无缝访问外汇、贵金属、指数、美股、港股、A 股、中国期货和加密货币等多个市场的行情数据。
...
### llms.txt — 为 AI 提供文档上下文

如需让 AI 助手了解 TickDB 文档，可向其提供以下地址：
